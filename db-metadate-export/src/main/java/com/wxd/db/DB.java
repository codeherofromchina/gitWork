...
public class DB {
	...
	private static final String DB_PWD_KEY = "jdbc.password";
	
	private static Properties prop = new Properties();
	
	static {
		try {
			InputStream resourceAsStream = DB.class.getClassLoader().getResourceAsStream("dao.properties");
			prop.load(resourceAsStream);
			Class.forName(prop.getProperty(DB_DRIVER_KEY)) ; 
		} catch (IOException e) {
			e.printStackTrace();
	...
	public static Connection getConnection() throws SQLException{
		Connection conn = DriverManager.getConnection(prop.getProperty(DB_URL_KEY), prop.getProperty(DB_USER_KEY), prop.getProperty(DB_PWD_KEY));
		return conn;
	}
	 ...
	 * @throws SQLException 
	 */
	public static DbMetadata getDbMetadata(String catalog,String schemaPattern, String tableNamePattern, String[] types) throws SQLException {
